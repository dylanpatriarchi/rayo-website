...
export default function Methodology() {
    ...
    return (
        ...
        >
            <div className="md:absolute top-12 left-6 md:left-12 z-10 py-12 px-6 md:p-0">
                <h2 className="text-sm font-bold uppercase tracking-widest text-primary">Metodologia</h2>
            </div>

            <div
                ref={containerRef}
                className="flex flex-col md:flex-row md:h-full md:w-fit"
            >
                {steps.map((step, index) => (
                    <div
                        key={index}
                        className="w-full md:w-screen h-[80vh] md:h-full flex flex-col justify-center px-6 md:px-24 border-b md:border-b-0 md:border-r border-white/10 shrink-0"
                    >
